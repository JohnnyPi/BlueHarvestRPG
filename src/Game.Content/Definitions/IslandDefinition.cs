...
public sealed class IslandDefinition
{
    ...
    public float MinBeachCoastDistance { get; set; } = 0.025f;
    public float MaxBeachCoastDistance { get; set; } = 0.06f;
    public float MinShallowWaterCoastDistance { get; set; } = 0.018f;
    public float MaxShallowWaterCoastDistance { get; set; } = 0.04f;
    public float CoastalWidthVariationFrequency { get; set; } = 3.5f;
    public int CoastalWidthSmoothingPasses { get; set; } = 3;
    ...
    public int VolcanicConeCount { get; set; } = 1;
    public float VolcanicConeRadius { get; set; } = 0.045f;
    public float VolcanicConeHeight { get; set; } = 0.35f;
    public float VolcanoProtectedCoreRadius { get; set; } = 1.05f;
    public float VolcanoRoadRingRadius { get; set; } = 1.35f;
    public int VolcanoRoadRingNodes { get; set; } = 8;
    public int LavaFlowCount { get; set; } = 3;
    public int LavaFlowMaxLength { get; set; } = 28;
    public int LavaFlowWidth { get; set; } = 2;
    public float LavaFlowMeanderStrength { get; set; } = 0.12f;
    public float LavaFlowTerminationRadius { get; set; } = 1.25f;
    public float LavaFlowRoadTraversalPenalty { get; set; } = 40f;
